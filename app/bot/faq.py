    ...
    def get_response(
        ...
        *,
        ...
        Args:
            ...
            phone: Sender's WhatsApp number. Kept for call-site compatibility;
                unused now that "precio" no longer builds a dynamic message.
            customer_name: Sender's contact name. Same as phone above.
